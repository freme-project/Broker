...
public class DatasetRepositoryTest {
	...
	public void testUserRepository(){
		...
		datasetRepository.save(new Dataset("1", testuser, Dataset.AccessLevel.PUBLIC));
		logger.info("create dataset \"2\" and save it");
		datasetRepository.save(new Dataset("2", testuser, Dataset.AccessLevel.PUBLIC));
		logger.info("create dataset \"3\" and save it");
		datasetRepository.save(new Dataset("3", testuser, Dataset.AccessLevel.PUBLIC));

		logger.info("fetch dataset \"2\"");
		Dataset two = datasetRepository.findOneByName("2");
		assertTrue(two!=null);
