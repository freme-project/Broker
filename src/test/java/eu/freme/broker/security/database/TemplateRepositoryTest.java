...
public class TemplateRepositoryTest {
	...
	public void testUserRepository(){
		...
		templateRepository.save(new Template("1", testuser, OwnedResource.AccessLevel.PUBLIC));
		logger.info("create template \"2\" and save it");
		templateRepository.save(new Template("2", testuser, OwnedResource.AccessLevel.PUBLIC));
		logger.info("create template \"3\" and save it");
		templateRepository.save(new Template("3", testuser, OwnedResource.AccessLevel.PUBLIC));
